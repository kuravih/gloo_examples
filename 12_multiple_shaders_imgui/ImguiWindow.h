...
// ====================================================================================================================
  ...
  // ==================================================================================================================
  class BoxWindow : public BaseWindow {
    gloo::Program boxShaderProgram;
  ...
  class CircleWindow : public BaseWindow {
    gloo::Program circleShaderProgram;
    gloo::Mesh screenMesh;
    ImVec2 viewSize, viewWindowSize;
    // common parameters
    glm::vec3 in_color1, in_color2;
    glm::vec2 in_mouse;
    // circle parameters
    glm::vec2 in_circle_center;
    float in_circle_radius;
    // render variables
    gloo::Texture renderTex;
    gloo::Framebuffer framebuffer;
    gloo::Renderbuffer renderbuffer;
  public:
    CircleWindow(bool& _show);
    ~CircleWindow();
    const std::string getWindowTitle() const override {
      return "Circle Window##"+std::to_string(getWindowIndex());
    }
    void Initialize(AppData& _appData) override;
    void Draw(AppData& _appData) override;
    void Deinitialize(AppData& _appData) override;
