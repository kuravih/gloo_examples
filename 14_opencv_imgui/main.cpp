...
int main(int argc, char **argv)
{
    ...
    glfw::Window window(1920, 1200, "14 Opencv Imgui");
    ...
    appData.ui.showImageAWindow = true;
    appData.ui.showImageBWindow = true;
    appData.ui.imageA = cv::Mat(cv::Size(IMAGE_WIDTH, IMAGE_HEIGHT), CV_16UC1, cv::Scalar(0));
    appData.ui.imageB = cv::Mat(cv::Size(IMAGE_WIDTH, IMAGE_HEIGHT), CV_16UC3, cv::Scalar(0, 0, 0));

    ImGui::ImageWindow imageAWindow(appData.ui.showImageAWindow);
    ImGui::ImageWindow imageBWindow(appData.ui.showImageBWindow);
    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    while (!window.ShouldClose())
    {
        ...
        // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        imageBWindow.Show(appData);
        imageAWindow.Show(appData);
        // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
