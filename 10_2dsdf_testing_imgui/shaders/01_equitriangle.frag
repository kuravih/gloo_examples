...
// input: circumcenter
uniform vec2 in_circumcenter;

// input: circumradius
uniform float in_circumradius;
...
// Equilateral triangle signed distance function
...
void main() {
  ...
  vec2 p = vert_texCoord-in_circumcenter;
  vec2 m = in_mouse-in_circumcenter;

  float d = sdEquilateralTriangle(p, in_circumradius);
  ...
  d = sdEquilateralTriangle(m, in_circumradius);
