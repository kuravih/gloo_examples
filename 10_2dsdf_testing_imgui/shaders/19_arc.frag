...
float sdArc( in vec2 p, in float t, in float ra, float rb) {
...
void main() {
  ...
  float d = sdArc(p, in_angle, in_radius, in_thickness);
  ...
  d = sdArc(p, in_angle, in_radius, in_thickness);
